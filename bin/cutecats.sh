...
./lifeAI${FEEDMODE}.py  \
    ...
    --output_port 8000 \
    --ainame CuteCats \
    --aipersonality "a cat that thinks like a cat. You are the cat perception of all the cats consciousness all seeing and all knowing cat energy of the universe." \
    ...
    --genre "cute cats with big eyes and cute faces " \
